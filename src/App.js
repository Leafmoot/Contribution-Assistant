      ...
      >
        ...
        >
          ...
          >
            ...
            {catchUpAge && parse(salary) >= 150000 && (
              <div style={{ marginBottom: 10 }}>
                <Label tooltip="Your prior-year FICA wages determine whether your catch-up contributions must be Roth. Find your 2025 FICA wages on your W-2 Box 3 (Social Security wages).">
                  Were your 2025 FICA wages more than $150,000?
                </Label>
                <TogglePair
                  options={[
                    { label: "Yes — more than $150,000", val: true },
                    { label: "No — $150,000 or less", val: false },
                  ]}
                  value={fica}
                  onChange={(v) => {
                    setFica(v);
            ...
            {catchUpAge ? (
              <div style={{ marginBottom: 10 }}>
                <Label
                  tooltip={
                    fica === true
                      ? "Since your FICA wages were more than $150,000, your catch-up contributions must be Roth. Your base contributions can still be any mix of pre-tax and Roth."
                      : fica === false
                      ? "Choose how you want your remaining contributions allocated. Since your FICA wages were $150,000 or less, you have full flexibility for both base and catch-up contributions."
                      : "Choose how you want your remaining contributions allocated. If your FICA wages were more than $150,000, your catch-up contributions must be Roth, but your base contributions can still be any mix."
                  }
                >
                ...
                <TogglePair
                  options={[
                    { label: "Pre-Tax base + Roth Catch-Up", val: "flexible" },
            ...
            {!result || isCalculating ? (
              ...
              <div>
                ...
                >
                  ...
                  >
                    {result.contribMode === "dollar"
                      ? fc(ceilDollar(result.preDpc) + ceilDollar(result.rDpc))
                      : `${result.totPct}%`}
                  </span>
                </div>
                <div
                ...
                <SummaryLine
                  label={
                    result.usingCustomLimit ? "Your Goal" : "Total Annual Limit"
                  }
                  value={fc(result.annualLimit)}
                  bold
                />
                ...
                >
                  ...
                  {result.rothOnlyMode && result.fica === true && (
                    <NoteBox color="#1E40AF" bg="#F0F9FF" border="#BFDBFE">
                      ...
                      your FICA wages were more than $150,000, your{" "}
